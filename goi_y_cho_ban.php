...
<?php
    ...
    // }
        ...
        ON tbl_sanpham.brandId = tbl_thuonghieu.brandId  where type = '1' order by productId desc LIMIT ".$item_per_page." OFFSET ".$offset."") ;
    	$totalRecords = mysqli_query($conn, "SELECT tbl_sanpham.*, tbl_thuonghieu.brandName  FROM tbl_sanpham JOIN tbl_thuonghieu
        ON tbl_sanpham.brandId = tbl_thuonghieu.brandId  where type = '1'");
        ...
        <div class="main_center_products-path">
            <div class="main_center_products-path_center">
                ...
                <!-- <?php 
                    ...
                    //         # code...
                ?> -->
                <li><a href="#">Gợi ý dành cho bạn</a></li>
                <!-- <?php 
                // }
                // }
                ?> -->
