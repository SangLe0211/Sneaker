    ...
    <div class="wraper_center_main_right-main--center center--padding--sanpham center--padding">
        ...
        <table class="table sanpham " >
            ...
            <tr>
					...
					?></td>
                <td>
                    <div class="btn_dssp btn_dssp--blue btn_kho">
                        <a href="index.php?action=capnhatnhaphang&query=nhaphang&productid=<?php echo $result['productId'] ?>">Nhập hàng</a>
                    </div>
                    <div class="btn_dssp btn_dssp--red btn_kho">
